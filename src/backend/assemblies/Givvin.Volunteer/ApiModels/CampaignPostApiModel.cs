using Givvin.Volunteer.AttributeValidators;
...
namespace Givvin.Volunteer.ApiModels
{
    ...
    /// </summary>
    public class CampaignPostApiModel
    {
        /// <summary>
        ...
        [DateGreaterThan(nameof(StartDate), ErrorMessage = "The end date must be greater than the start date.")]
